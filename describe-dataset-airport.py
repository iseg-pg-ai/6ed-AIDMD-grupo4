...
df = pd.read_csv('./Datasets/airport_traffic_2025.csv')
...
print("-------------------------------")    
print("Contagem de aeroportos únicos:", df['APT_NAME'].value_counts())  # Contagem de aeroportos únicos
print("-------------------------------")   
print("Contagem de estados únicos:", df['STATE_NAME'].value_counts())  # Contagem de estados únicos
print("-------------------------------")   
print("Intervalo de datas:", df['FLT_DATE'].min(), df['FLT_DATE'].max())  # Intervalo de datas
print("-------------------------------")   
print("Tipo de dados da coluna de data:",df['FLT_DATE'].dtype)  # Tipo de dado da coluna de data
print("-------------------------------")   
